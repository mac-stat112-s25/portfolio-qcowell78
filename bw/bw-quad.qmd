...
ggplot(aes(x = expend, y = sat, size = salary, color = fracCat)) +
  ...
  labs(title = "Simpson's paradox and average SAT scores by state, 1994-95", subtitle = "How test-taker ratios obscure the impact of education funding", y = "Avg. SAT score")
```
